...
│   ├── skills/{feature,ingest,implement,understand,security-test,portfolio,peggy,peggy-doctor,daemonize,fork-hack,ship-ios,fleet,host,commit}/SKILL.md
